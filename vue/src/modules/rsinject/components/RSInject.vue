<template>
	...
	<template v-if="loaded">
		...
		<template v-else>
			<a class="rsi-enable-link" @click="enable" :title="dictionary.link_enable">{{ dictionary.link_enable }}</a>
		</template>
	</template>
	<template v-else>
		<a class="rsi-load-link" @click="load"  :title="dictionary.link_load">{{ dictionary.link_load }}</a>
	</template>
